...
class AnamaliaViewer {
    ...
    updateTennerSpecificOptions() {
        ...
        // Get options from loaded Tenner data
        const tennerOptions = {};
        
        if (this.tennerData && this.tennerData.categories) {
            // Use real Tenner data
            console.log('📊 Using real Tenner data:', Object.keys(this.tennerData.categories));
            Object.keys(this.tennerData.categories).forEach(tennerKey => {
                const options = this.tennerData.categories[tennerKey];
                tennerOptions[tennerKey] = options.map(option => {
                    return `${tennerKey}-${option.option_index}: ${option.descriptor}`;
                });
                console.log(`📋 ${tennerKey} options:`, tennerOptions[tennerKey]);
            });
        } else {
            // No fallback data - fail clearly if real data isn't loaded
            console.error('❌ Tenner data not loaded! Real data must be available.');
            console.error('❌ This indicates a problem with data loading from CSV files.');
            return; // Exit early if no real data
        }
        
        // Use only real data - no fallback
        const finalTennerOptions = tennerOptions;
        ...
        ['tenner-1', 'tenner-2', 'tenner-3'].forEach((tennerId, index) => {
            ...
            'T2': [
                'T2-0: Cowboy Hat',
                'T2-1: Sideways Baseball Cap',
                'T2-2: Knight\'s Helmet',
                'T2-3: Top Hat',
                'T2-4: Beanie',
                'T2-5: Sun Hat',
                'T2-6: Beret',
            ...
            'T8': [
                'T8-0: Arms Open Welcome',
                'T8-1: Seated Contemplative',
                'T8-2: Standing Confident',
                'T8-3: Leaning Casual',
                'T8-4: Pointing Gesture',
                'T8-5: Hands on Hips',
                'T8-6: Arms Crossed',
                'T8-7: Bowing Politely',
                'T8-8: Waving Hello',
                'T8-9: Thumbs Up'
            ],
            'T9': [
                'T9-0: Golden Hour Sunlight',
                'T9-1: Soft Studio Lighting',
                'T9-2: Dramatic Shadows',
                'T9-3: Warm Candlelight',
                'T9-4: Cool Moonlight',
                'T9-5: Bright Daylight',
                'T9-6: Moody Overcast',
                'T9-7: Firelight Glow',
                'T9-8: Neon City Lights',
                'T9-9: Starlit Night'
            ],
            'T10': [
                'T10-0: Fresh Lavender',
                'T10-1: Warm Vanilla',
                'T10-2: Pine Forest',
                'T10-3: Ocean Breeze',
                'T10-4: Rose Garden',
                'T10-5: Coffee Beans',
                'T10-6: Cinnamon Spice',
                'T10-7: Citrus Zest',
                'T10-8: Wood Smoke',
                'T10-9: Rain on Earth'
            ],
            'T11': [
                'T11-0: Joyful Smile',
                'T11-1: Thoughtful Frown',
                'T11-2: Surprised Eyes',
                'T11-3: Determined Gaze',
                'T11-4: Mischievous Grin',
                'T11-5: Calm Serenity',
                'T11-6: Excited Anticipation',
                'T11-7: Wise Contemplation',
                'T11-8: Playful Wink',
                'T11-9: Gentle Kindness'
            ],
            'T12': [
                'T12-0: Pointing Forward',
                'T12-1: Arms Crossed',
                'T12-2: Thumbs Up',
                'T12-3: Waving Hello',
                'T12-4: Hand on Heart',
                'T12-5: Clapping Hands',
                'T12-6: Shaking Head',
                'T12-7: Nodding Yes',
                'T12-8: Finger to Lips',
                'T12-9: Open Arms'
            ],
            'T13': [
                'T13-0: Pure Joy',
                ...
                'T13-2: Burning Anger',
                'T13-3: Calm Peace',
                'T13-4: Wild Excitement',
                'T13-5: Gentle Love',
                'T13-6: Fierce Determination',
                'T13-7: Quiet Melancholy',
                'T13-8: Radiant Hope',
                'T13-9: Mysterious Wonder'
            ],
            'T14': [
                'T14-0: Reading Books',
                'T14-1: Playing Music',
                'T14-2: Cooking Meals',
                'T14-3: Gardening Plants',
                'T14-4: Painting Pictures',
                'T14-5: Dancing Freely',
                'T14-6: Building Things',
                'T14-7: Exploring Nature',
                'T14-8: Teaching Others',
                'T14-9: Dreaming Big'
            ],
            'T15': [
                'T15-0: Cozy Home',
                'T15-1: Bustling Market',
                'T15-2: Quiet Library',
                'T15-3: Vibrant Garden',
                'T15-4: Mountain Peak',
                'T15-5: Ocean Shore',
                'T15-6: Forest Clearing',
                'T15-7: City Rooftop',
                'T15-8: Desert Oasis',
                'T15-9: Snowy Village'
            ],
            'T16': [
                ...
                'T16-7: Misty Dawn',
                'T16-8: Thunderstorm',
                'T16-9: Perfect Weather'
            ],
            'T17': [
                'T17-0: Early Dawn',
                'T17-1: Morning Light',
                'T17-2: Noon Sun',
                'T17-3: Afternoon Glow',
                'T17-4: Golden Hour',
                'T17-5: Evening Twilight',
                'T17-6: Sunset Colors',
                'T17-7: Night Darkness',
                'T17-8: Midnight Stars',
                'T17-9: Pre-Dawn Silence'
            ],
            'T18': [
                'T18-0: Spring Awakening',
                'T18-1: Summer Growth',
                'T18-2: Autumn Harvest',
                'T18-3: Winter Rest',
                'T18-4: Blooming Flowers',
                'T18-5: Ripe Fruits',
                'T18-6: Falling Leaves',
                'T18-7: Snowy Blanket',
                'T18-8: Renewal Time',
                'T18-9: Eternal Cycle'
            ],
            ...
            'T21': [
                ...
                'T21-1: Polka Dots',
                'T21-2: Floral Prints',
                'T21-3: Geometric Shapes',
                'T21-4: Swirl Designs',
                'T21-5: Checkered Grid',
                'T21-6: Zigzag Lines',
                'T21-7: Spiral Curves',
                'T21-8: Abstract Forms',
                'T21-9: Organic Patterns'
            ],
            'T22': [
                'T22-0: Perfect Circle',
                'T22-1: Sharp Triangle',
                'T22-2: Stable Square',
                'T22-3: Flowing Oval',
                'T22-4: Angular Diamond',
                'T22-5: Curved Crescent',
                'T22-6: Straight Line',
                'T22-7: Wavy Form',
                'T22-8: Spiral Shape',
                'T22-9: Natural Curve'
            ...
            'T23': [
                'T23-0: Tiny Miniature',
                'T23-1: Small Scale',
                'T23-2: Medium Size',
                'T23-3: Large Scale',
                'T23-4: Giant Proportions',
                'T23-5: Compact Form',
                'T23-6: Spacious Volume',
                'T23-7: Narrow Width',
                'T23-8: Broad Stance',
                'T23-9: Perfect Balance'
            ],
            'T24': [
                'T24-0: Young Child',
                'T24-1: Growing Teen',
                ...
                'T24-5: Ancient Soul',
                'T24-6: Eternal Youth',
                'T24-7: Timeless Being',
                'T24-8: Age of Wisdom',
                'T24-9: Infinite Journey'
            ],
            'T25': [
                'T25-0: Master Artist',
                'T25-1: Wise Teacher',
                'T25-2: Brave Explorer',
                'T25-3: Gentle Healer',
                'T25-4: Skilled Builder',
                'T25-5: Musical Performer',
                'T25-6: Storyteller',
                'T25-7: Guardian Protector',
                'T25-8: Dreamer Visionary',
                'T25-9: Universal Friend'
            ],
            'T26': [
                'T26-0: Melodic Piano',
                'T26-1: Soothing Violin',
                'T26-2: Rhythmic Drums',
                'T26-3: Gentle Guitar',
                'T26-4: Bright Trumpet',
                'T26-5: Deep Bass',
                'T26-6: Flowing Flute',
                'T26-7: Harmonic Harp',
                'T26-8: Soulful Saxophone',
                'T26-9: Universal Harmony'
            ],
            'T27': [
                'T27-0: Magic Card Trick',
                'T27-1: Balancing Act',
                'T27-2: Juggling Balls',
                'T27-3: Disappearing Coin',
                'T27-4: Levitation Illusion',
                'T27-5: Mind Reading',
                'T27-6: Escape Artist',
                'T27-7: Fire Breathing',
                'T27-8: Teleportation',
                'T27-9: Impossible Feat'
            ],
            'T28': [
                'T28-0: Theatrical Drama',
                'T28-1: Musical Comedy',
                'T28-2: Dance Spectacle',
                'T28-3: Puppet Show',
                'T28-4: Acrobatic Display',
                'T28-5: Poetry Recital',
                'T28-6: Storytelling',
                'T28-7: Magic Show',
                'T28-8: Circus Act',
                'T28-9: Universal Performance'
            ],
            'T29': [
                'T29-0: Nomadic Wanderer',
                'T29-1: City Dweller',
                'T29-2: Country Farmer',
                'T29-3: Mountain Hermit',
                'T29-4: Coastal Sailor',
                'T29-5: Forest Guardian',
                'T29-6: Desert Nomad',
                'T29-7: Urban Artist',
                'T29-8: Rural Craftsman',
                'T29-9: Universal Citizen'
            ],
            'T30': [
                'T30-0: Beloved Partner',
                'T30-1: Cherished Friend',
                'T30-2: Devoted Parent',
                'T30-3: Loyal Companion',
                'T30-4: Trusted Mentor',
                'T30-5: Adored Sibling',
                'T30-6: Respected Elder',
                'T30-7: Treasured Child',
                'T30-8: Soul Connection',
                'T30-9: Universal Love'
            ],
            'T31': [
                'T31-0: Vanishing Act',
                'T31-1: Time Travel',
                'T31-2: Shape Shifting',
                'T31-3: Invisibility',
                'T31-4: Teleportation',
                'T31-5: Mind Control',
                'T31-6: Elemental Power',
                'T31-7: Dimensional Shift',
                'T31-8: Reality Warp',
                'T31-9: Ultimate Mystery'
            ],
            'T32': [
                'T32-0: "Follow your dreams"',
                'T32-1: "Believe in yourself"',
                'T32-2: "Love conquers all"',
                'T32-3: "Never give up"',
                'T32-4: "Be kind always"',
                'T32-5: "Create your magic"',
                'T32-6: "Find your truth"',
                'T32-7: "Embrace change"',
                'T32-8: "Live fully now"',
                'T32-9: "You are enough"'
            ]
        };
        
        // Use real data if available, otherwise fall back to legacy data
        const finalTennerOptions = Object.keys(tennerOptions).length > 0 ? tennerOptions : legacyTennerOptions;
        ...
        ['tenner-1', 'tenner-2', 'tenner-3'].forEach((tennerId, index) => {
            ...
            // Show/hide specific option dropdown based on mode and Tenner selection
            if (mode === 'single' && selectedTenner && selectedTenner !== 'none') {
                optionDiv.style.display = 'block';
                ...
                // Populate with options for the selected Tenner
                if (finalTennerOptions[selectedTenner]) {
                    finalTennerOptions[selectedTenner].forEach(option => {
    ...
    async loadTennerData() {
        try {
            console.log('📊 Loading Tenner data...');
            ...
            console.log('✅ Tenner summary loaded successfully');
            ...
            // Load each Tenner category CSV file
            for (let i = 1; i <= 32; i++) {
                const tennerNum = i.toString().padStart(2, '0');
                try {
                    const csvResponse = await fetch(`data/tenner_32/tenner_${tennerNum}.csv`);
                    if (csvResponse.ok) {
                        const csvText = await csvResponse.text();
                        const options = this.parseCSV(csvText);
                        this.tennerData.categories[`T${i}`] = options;
                        console.log(`✅ Loaded T${i} with ${options.length} options`);
                        if (i === 2) { // Debug T2 specifically
                            console.log('🔍 T2 options:', options);
                            console.log('🔍 T2 option 9:', options.find(opt => opt.option_index === 9));
                        }
                    } else {
                        console.warn(`⚠️ Could not load T${i} data - Status: ${csvResponse.status}`);
                    }
                } catch (error) {
                    console.warn(`⚠️ Error loading T${i}:`, error);
                }
            }
    ...
    parseCSV(csvText) {
        ...
        for (let i = 1; i < lines.length; i++) {
            ...
            if (values.length >= 4) {
                const optionIndex = parseInt(values[3]) || i - 1;
                
                // Only include options 0-9 (first 10 options)
    ...
    getFallbackTennerData() {
        // Fallback data if CSV files can't be loaded
        return {
            categories: {
                // T1: Characters (10 options)
                'T1': [
                    { id: 'tenner_01_00', descriptor: 'rhino named Ruby', option_index: 0 },
                    { id: 'tenner_01_01', descriptor: 'mouse named Maxine', option_index: 1 },
                    { id: 'tenner_01_02', descriptor: 'sloth named Sammy', option_index: 2 },
                    { id: 'tenner_01_03', descriptor: 'lion named Lisa', option_index: 3 },
                    { id: 'tenner_01_04', descriptor: 'moose named Mabel', option_index: 4 },
                    { id: 'tenner_01_05', descriptor: 'bear named Betty', option_index: 5 },
                    { id: 'tenner_01_06', descriptor: 'wolf named Wendy', option_index: 6 },
                    { id: 'tenner_01_07', descriptor: 'orangutan named Ozzie', option_index: 7 },
                    { id: 'tenner_01_08', descriptor: 'gazelle named Gertrude', option_index: 8 },
                    { id: 'tenner_01_09', descriptor: 'elephant named Ellie', option_index: 9 }
                ],
                // T2: Headwear (10 options)
                'T2': [
                    { id: 'tenner_02_00', descriptor: 'a tall cowboy hat with a star on it', option_index: 0 },
                    { id: 'tenner_02_01', descriptor: 'a avant garde purple mohawk', option_index: 1 },
                    { id: 'tenner_02_02', descriptor: 'a sideways baseball cap', option_index: 2 },
                    { id: 'tenner_02_03', descriptor: 'a tiara of french fries', option_index: 3 },
                    { id: 'tenner_02_04', descriptor: 'a wizard hat with stars', option_index: 4 },
                    { id: 'tenner_02_05', descriptor: 'a construction hard hat', option_index: 5 },
                    { id: 'tenner_02_06', descriptor: 'a flower crown', option_index: 6 },
                    { id: 'tenner_02_07', descriptor: 'a pilot cap with goggles', option_index: 7 },
                    { id: 'tenner_02_08', descriptor: 'a chef toque', option_index: 8 },
                    { id: 'tenner_02_09', descriptor: 'a flamboyant hat of swan feathers', option_index: 9 }
                ],
                // T3: Garments (10 options)
                'T3': [
                    { id: 'tenner_03_00', descriptor: 'a denim jacket', option_index: 0 },
                    { id: 'tenner_03_01', descriptor: 'a lab coat', option_index: 1 },
                    { id: 'tenner_03_02', descriptor: 'a tuxedo', option_index: 2 },
                    { id: 'tenner_03_03', descriptor: 'a hoodie', option_index: 3 },
                    { id: 'tenner_03_04', descriptor: 'a vest', option_index: 4 },
                    { id: 'tenner_03_05', descriptor: 'a cardigan', option_index: 5 },
                    { id: 'tenner_03_06', descriptor: 'a blazer', option_index: 6 },
                    { id: 'tenner_03_07', descriptor: 'overalls', option_index: 7 },
                    { id: 'tenner_03_08', descriptor: 'a sweater', option_index: 8 },
                    { id: 'tenner_03_09', descriptor: 'a shirt', option_index: 9 }
                ],
                // T4: Accessories (10 options)
                'T4': [
                    { id: 'tenner_04_00', descriptor: 'glasses', option_index: 0 },
                    { id: 'tenner_04_01', descriptor: 'a watch', option_index: 1 },
                    { id: 'tenner_04_02', descriptor: 'a scarf', option_index: 2 },
                    { id: 'tenner_04_03', descriptor: 'gloves', option_index: 3 },
                    { id: 'tenner_04_04', descriptor: 'a belt', option_index: 4 },
                    { id: 'tenner_04_05', descriptor: 'a tie', option_index: 5 },
                    { id: 'tenner_04_06', descriptor: 'a bow tie', option_index: 6 },
                    { id: 'tenner_04_07', descriptor: 'suspenders', option_index: 7 },
                    { id: 'tenner_04_08', descriptor: 'cufflinks', option_index: 8 },
                    { id: 'tenner_04_09', descriptor: 'a pocket square', option_index: 9 }
                ],
                // T5: Props (10 options)
                'T5': [
                    { id: 'tenner_05_00', descriptor: 'a book', option_index: 0 },
                    { id: 'tenner_05_01', descriptor: 'a camera', option_index: 1 },
                    { id: 'tenner_05_02', descriptor: 'a tool', option_index: 2 },
                    { id: 'tenner_05_03', descriptor: 'an instrument', option_index: 3 },
                    { id: 'tenner_05_04', descriptor: 'a flower', option_index: 4 },
                    { id: 'tenner_05_05', descriptor: 'a cup', option_index: 5 },
                    { id: 'tenner_05_06', descriptor: 'a bag', option_index: 6 },
                    { id: 'tenner_05_07', descriptor: 'a flag', option_index: 7 },
                    { id: 'tenner_05_08', descriptor: 'a key', option_index: 8 },
                    { id: 'tenner_05_09', descriptor: 'a coin', option_index: 9 }
                ],
                // T6-T10: Extended Character Variations
                'T6': [
                    { id: 'tenner_06_00', descriptor: 'a friendly expression', option_index: 0 },
                    { id: 'tenner_06_01', descriptor: 'a curious expression', option_index: 1 },
                    { id: 'tenner_06_02', descriptor: 'a calm expression', option_index: 2 },
                    { id: 'tenner_06_03', descriptor: 'a strong expression', option_index: 3 },
                    { id: 'tenner_06_04', descriptor: 'a clever expression', option_index: 4 },
                    { id: 'tenner_06_05', descriptor: 'a mysterious expression', option_index: 5 },
                    { id: 'tenner_06_06', descriptor: 'an intelligent expression', option_index: 6 },
                    { id: 'tenner_06_07', descriptor: 'a cheerful expression', option_index: 7 },
                    { id: 'tenner_06_08', descriptor: 'a quick expression', option_index: 8 },
                    { id: 'tenner_06_09', descriptor: 'an elegant expression', option_index: 9 }
                ],
                'T7': [
                    { id: 'tenner_07_00', descriptor: 'standing pose', option_index: 0 },
                    { id: 'tenner_07_01', descriptor: 'sitting pose', option_index: 1 },
                    { id: 'tenner_07_02', descriptor: 'walking pose', option_index: 2 },
                    { id: 'tenner_07_03', descriptor: 'running pose', option_index: 3 },
                    { id: 'tenner_07_04', descriptor: 'jumping pose', option_index: 4 },
                    { id: 'tenner_07_05', descriptor: 'dancing pose', option_index: 5 },
                    { id: 'tenner_07_06', descriptor: 'thinking pose', option_index: 6 },
                    { id: 'tenner_07_07', descriptor: 'waving pose', option_index: 7 },
                    { id: 'tenner_07_08', descriptor: 'pointing pose', option_index: 8 },
                    { id: 'tenner_07_09', descriptor: 'resting pose', option_index: 9 }
                ],
                'T8': [
                    { id: 'tenner_08_00', descriptor: 'warm lighting', option_index: 0 },
                    { id: 'tenner_08_01', descriptor: 'cool lighting', option_index: 1 },
                    { id: 'tenner_08_02', descriptor: 'golden hour lighting', option_index: 2 },
                    { id: 'tenner_08_03', descriptor: 'dramatic lighting', option_index: 3 },
                    { id: 'tenner_08_04', descriptor: 'soft lighting', option_index: 4 },
                    { id: 'tenner_08_05', descriptor: 'harsh lighting', option_index: 5 },
                    { id: 'tenner_08_06', descriptor: 'moody lighting', option_index: 6 },
                    { id: 'tenner_08_07', descriptor: 'natural lighting', option_index: 7 },
                    { id: 'tenner_08_08', descriptor: 'artificial lighting', option_index: 8 },
                    { id: 'tenner_08_09', descriptor: 'colored lighting', option_index: 9 }
                ],
                'T9': [
                    { id: 'tenner_09_00', descriptor: 'forest scene', option_index: 0 },
                    { id: 'tenner_09_01', descriptor: 'city scene', option_index: 1 },
                    { id: 'tenner_09_02', descriptor: 'beach scene', option_index: 2 },
                    { id: 'tenner_09_03', descriptor: 'mountain scene', option_index: 3 },
                    { id: 'tenner_09_04', descriptor: 'desert scene', option_index: 4 },
                    { id: 'tenner_09_05', descriptor: 'garden scene', option_index: 5 },
                    { id: 'tenner_09_06', descriptor: 'library scene', option_index: 6 },
                    { id: 'tenner_09_07', descriptor: 'kitchen scene', option_index: 7 },
                    { id: 'tenner_09_08', descriptor: 'studio scene', option_index: 8 },
                    { id: 'tenner_09_09', descriptor: 'outdoor scene', option_index: 9 }
                ],
                'T10': [
                    { id: 'tenner_10_00', descriptor: 'happy mood', option_index: 0 },
                    { id: 'tenner_10_01', descriptor: 'sad mood', option_index: 1 },
                    { id: 'tenner_10_02', descriptor: 'excited mood', option_index: 2 },
                    { id: 'tenner_10_03', descriptor: 'calm mood', option_index: 3 },
                    { id: 'tenner_10_04', descriptor: 'confident mood', option_index: 4 },
                    { id: 'tenner_10_05', descriptor: 'shy mood', option_index: 5 },
                    { id: 'tenner_10_06', descriptor: 'playful mood', option_index: 6 },
                    { id: 'tenner_10_07', descriptor: 'serious mood', option_index: 7 },
                    { id: 'tenner_10_08', descriptor: 'mysterious mood', option_index: 8 },
                    { id: 'tenner_10_09', descriptor: 'peaceful mood', option_index: 9 }
                ],
                // T11-T20: Extended Wardrobe and Style
                'T11': [
                    { id: 'tenner_11_00', descriptor: 'casual style', option_index: 0 },
                    { id: 'tenner_11_01', descriptor: 'formal style', option_index: 1 },
                    { id: 'tenner_11_02', descriptor: 'vintage style', option_index: 2 },
                    { id: 'tenner_11_03', descriptor: 'modern style', option_index: 3 },
                    { id: 'tenner_11_04', descriptor: 'bohemian style', option_index: 4 },
                    { id: 'tenner_11_05', descriptor: 'sporty style', option_index: 5 },
                    { id: 'tenner_11_06', descriptor: 'artistic style', option_index: 6 },
                    { id: 'tenner_11_07', descriptor: 'professional style', option_index: 7 },
                    { id: 'tenner_11_08', descriptor: 'elegant style', option_index: 8 },
                    { id: 'tenner_11_09', descriptor: 'quirky style', option_index: 9 }
                ],
                'T12': [
                    { id: 'tenner_12_00', descriptor: 'red color scheme', option_index: 0 },
                    { id: 'tenner_12_01', descriptor: 'blue color scheme', option_index: 1 },
                    { id: 'tenner_12_02', descriptor: 'green color scheme', option_index: 2 },
                    { id: 'tenner_12_03', descriptor: 'yellow color scheme', option_index: 3 },
                    { id: 'tenner_12_04', descriptor: 'purple color scheme', option_index: 4 },
                    { id: 'tenner_12_05', descriptor: 'orange color scheme', option_index: 5 },
                    { id: 'tenner_12_06', descriptor: 'pink color scheme', option_index: 6 },
                    { id: 'tenner_12_07', descriptor: 'brown color scheme', option_index: 7 },
                    { id: 'tenner_12_08', descriptor: 'gray color scheme', option_index: 8 },
                    { id: 'tenner_12_09', descriptor: 'black and white scheme', option_index: 9 }
                ],
                'T13': [
                    { id: 'tenner_13_00', descriptor: 'cotton fabric', option_index: 0 },
                    { id: 'tenner_13_01', descriptor: 'silk fabric', option_index: 1 },
                    { id: 'tenner_13_02', descriptor: 'wool fabric', option_index: 2 },
                    { id: 'tenner_13_03', descriptor: 'denim fabric', option_index: 3 },
                    { id: 'tenner_13_04', descriptor: 'leather fabric', option_index: 4 },
                    { id: 'tenner_13_05', descriptor: 'linen fabric', option_index: 5 },
                    { id: 'tenner_13_06', descriptor: 'velvet fabric', option_index: 6 },
                    { id: 'tenner_13_07', descriptor: 'canvas fabric', option_index: 7 },
                    { id: 'tenner_13_08', descriptor: 'satin fabric', option_index: 8 },
                    { id: 'tenner_13_09', descriptor: 'tweed fabric', option_index: 9 }
                ],
                'T14': [
                    { id: 'tenner_14_00', descriptor: 'small size', option_index: 0 },
                    { id: 'tenner_14_01', descriptor: 'medium size', option_index: 1 },
                    { id: 'tenner_14_02', descriptor: 'large size', option_index: 2 },
                    { id: 'tenner_14_03', descriptor: 'extra large size', option_index: 3 },
                    { id: 'tenner_14_04', descriptor: 'oversized', option_index: 4 },
                    { id: 'tenner_14_05', descriptor: 'fitted size', option_index: 5 },
                    { id: 'tenner_14_06', descriptor: 'loose size', option_index: 6 },
                    { id: 'tenner_14_07', descriptor: 'tight size', option_index: 7 },
                    { id: 'tenner_14_08', descriptor: 'stretchy size', option_index: 8 },
                    { id: 'tenner_14_09', descriptor: 'adjustable size', option_index: 9 }
                ],
                'T15': [
                    { id: 'tenner_15_00', descriptor: 'bright texture', option_index: 0 },
                    { id: 'tenner_15_01', descriptor: 'matte texture', option_index: 1 },
                    { id: 'tenner_15_02', descriptor: 'glossy texture', option_index: 2 },
                    { id: 'tenner_15_03', descriptor: 'rough texture', option_index: 3 },
                    { id: 'tenner_15_04', descriptor: 'smooth texture', option_index: 4 },
                    { id: 'tenner_15_05', descriptor: 'soft texture', option_index: 5 },
                    { id: 'tenner_15_06', descriptor: 'hard texture', option_index: 6 },
                    { id: 'tenner_15_07', descriptor: 'fuzzy texture', option_index: 7 },
                    { id: 'tenner_15_08', descriptor: 'shiny texture', option_index: 8 },
                    { id: 'tenner_15_09', descriptor: 'patterned texture', option_index: 9 }
                ],
                'T16': [
                    { id: 'tenner_16_00', descriptor: 'morning time', option_index: 0 },
                    { id: 'tenner_16_01', descriptor: 'afternoon time', option_index: 1 },
                    { id: 'tenner_16_02', descriptor: 'evening time', option_index: 2 },
                    { id: 'tenner_16_03', descriptor: 'night time', option_index: 3 },
                    { id: 'tenner_16_04', descriptor: 'dawn time', option_index: 4 },
                    { id: 'tenner_16_05', descriptor: 'dusk time', option_index: 5 },
                    { id: 'tenner_16_06', descriptor: 'midday time', option_index: 6 },
                    { id: 'tenner_16_07', descriptor: 'midnight time', option_index: 7 },
                    { id: 'tenner_16_08', descriptor: 'sunrise time', option_index: 8 },
                    { id: 'tenner_16_09', descriptor: 'sunset time', option_index: 9 }
                ],
                'T17': [
                    { id: 'tenner_17_00', descriptor: 'spring season', option_index: 0 },
                    { id: 'tenner_17_01', descriptor: 'summer season', option_index: 1 },
                    { id: 'tenner_17_02', descriptor: 'autumn season', option_index: 2 },
                    { id: 'tenner_17_03', descriptor: 'winter season', option_index: 3 },
                    { id: 'tenner_17_04', descriptor: 'rainy season', option_index: 4 },
                    { id: 'tenner_17_05', descriptor: 'dry season', option_index: 5 },
                    { id: 'tenner_17_06', descriptor: 'windy season', option_index: 6 },
                    { id: 'tenner_17_07', descriptor: 'snowy season', option_index: 7 },
                    { id: 'tenner_17_08', descriptor: 'sunny season', option_index: 8 },
                    { id: 'tenner_17_09', descriptor: 'cloudy season', option_index: 9 }
                ],
                'T18': [
                    { id: 'tenner_18_00', descriptor: 'indoor setting', option_index: 0 },
                    { id: 'tenner_18_01', descriptor: 'outdoor setting', option_index: 1 },
                    { id: 'tenner_18_02', descriptor: 'urban setting', option_index: 2 },
                    { id: 'tenner_18_03', descriptor: 'rural setting', option_index: 3 },
                    { id: 'tenner_18_04', descriptor: 'coastal setting', option_index: 4 },
                    { id: 'tenner_18_05', descriptor: 'mountain setting', option_index: 5 },
                    { id: 'tenner_18_06', descriptor: 'desert setting', option_index: 6 },
                    { id: 'tenner_18_07', descriptor: 'forest setting', option_index: 7 },
                    { id: 'tenner_18_08', descriptor: 'arctic setting', option_index: 8 },
                    { id: 'tenner_18_09', descriptor: 'tropical setting', option_index: 9 }
                ],
                'T19': [
                    { id: 'tenner_19_00', descriptor: 'close-up shot', option_index: 0 },
                    { id: 'tenner_19_01', descriptor: 'medium shot', option_index: 1 },
                    { id: 'tenner_19_02', descriptor: 'wide shot', option_index: 2 },
                    { id: 'tenner_19_03', descriptor: 'extreme close-up', option_index: 3 },
                    { id: 'tenner_19_04', descriptor: 'long shot', option_index: 4 },
                    { id: 'tenner_19_05', descriptor: 'bird\'s eye view', option_index: 5 },
                    { id: 'tenner_19_06', descriptor: 'worm\'s eye view', option_index: 6 },
                    { id: 'tenner_19_07', descriptor: 'profile shot', option_index: 7 },
                    { id: 'tenner_19_08', descriptor: 'three-quarter shot', option_index: 8 },
                    { id: 'tenner_19_09', descriptor: 'over-the-shoulder shot', option_index: 9 }
                ],
                'T20': [
                    { id: 'tenner_20_00', descriptor: 'vibrant colors', option_index: 0 },
                    { id: 'tenner_20_01', descriptor: 'muted colors', option_index: 1 },
                    { id: 'tenner_20_02', descriptor: 'monochrome colors', option_index: 2 },
                    { id: 'tenner_20_03', descriptor: 'pastel colors', option_index: 3 },
                    { id: 'tenner_20_04', descriptor: 'neon colors', option_index: 4 },
                    { id: 'tenner_20_05', descriptor: 'earth tones', option_index: 5 },
                    { id: 'tenner_20_06', descriptor: 'cool tones', option_index: 6 },
                    { id: 'tenner_20_07', descriptor: 'warm tones', option_index: 7 },
                    { id: 'tenner_20_08', descriptor: 'complementary colors', option_index: 8 },
                    { id: 'tenner_20_09', descriptor: 'analogous colors', option_index: 9 }
                ],
                // T21-T32: Extended Creative Elements
                'T21': [
                    { id: 'tenner_21_00', descriptor: 'realistic style', option_index: 0 },
                    { id: 'tenner_21_01', descriptor: 'cartoon style', option_index: 1 },
                    { id: 'tenner_21_02', descriptor: 'anime style', option_index: 2 },
                    { id: 'tenner_21_03', descriptor: 'pixel art style', option_index: 3 },
                    { id: 'tenner_21_04', descriptor: 'watercolor style', option_index: 4 },
                    { id: 'tenner_21_05', descriptor: 'oil painting style', option_index: 5 },
                    { id: 'tenner_21_06', descriptor: 'sketch style', option_index: 6 },
                    { id: 'tenner_21_07', descriptor: 'digital art style', option_index: 7 },
                    { id: 'tenner_21_08', descriptor: 'vintage style', option_index: 8 },
                    { id: 'tenner_21_09', descriptor: 'modern style', option_index: 9 }
                ],
                'T22': [
                    { id: 'tenner_22_00', descriptor: 'high contrast', option_index: 0 },
                    { id: 'tenner_22_01', descriptor: 'low contrast', option_index: 1 },
                    { id: 'tenner_22_02', descriptor: 'balanced contrast', option_index: 2 },
                    { id: 'tenner_22_03', descriptor: 'dramatic contrast', option_index: 3 },
                    { id: 'tenner_22_04', descriptor: 'subtle contrast', option_index: 4 },
                    { id: 'tenner_22_05', descriptor: 'extreme contrast', option_index: 5 },
                    { id: 'tenner_22_06', descriptor: 'soft contrast', option_index: 6 },
                    { id: 'tenner_22_07', descriptor: 'harsh contrast', option_index: 7 },
                    { id: 'tenner_22_08', descriptor: 'natural contrast', option_index: 8 },
                    { id: 'tenner_22_09', descriptor: 'artificial contrast', option_index: 9 }
                ],
                'T23': [
                    { id: 'tenner_23_00', descriptor: 'bright saturation', option_index: 0 },
                    { id: 'tenner_23_01', descriptor: 'muted saturation', option_index: 1 },
                    { id: 'tenner_23_02', descriptor: 'desaturated', option_index: 2 },
                    { id: 'tenner_23_03', descriptor: 'oversaturated', option_index: 3 },
                    { id: 'tenner_23_04', descriptor: 'natural saturation', option_index: 4 },
                    { id: 'tenner_23_05', descriptor: 'artificial saturation', option_index: 5 },
                    { id: 'tenner_23_06', descriptor: 'selective saturation', option_index: 6 },
                    { id: 'tenner_23_07', descriptor: 'gradient saturation', option_index: 7 },
                    { id: 'tenner_23_08', descriptor: 'uniform saturation', option_index: 8 },
                    { id: 'tenner_23_09', descriptor: 'variable saturation', option_index: 9 }
                ],
                'T24': [
                    { id: 'tenner_24_00', descriptor: 'sharp focus', option_index: 0 },
                    { id: 'tenner_24_01', descriptor: 'soft focus', option_index: 1 },
                    { id: 'tenner_24_02', descriptor: 'blurred background', option_index: 2 },
                    { id: 'tenner_24_03', descriptor: 'shallow depth of field', option_index: 3 },
                    { id: 'tenner_24_04', descriptor: 'deep depth of field', option_index: 4 },
                    { id: 'tenner_24_05', descriptor: 'selective focus', option_index: 5 },
                    { id: 'tenner_24_06', descriptor: 'tilt-shift effect', option_index: 6 },
                    { id: 'tenner_24_07', descriptor: 'macro focus', option_index: 7 },
                    { id: 'tenner_24_08', descriptor: 'infinity focus', option_index: 8 },
                    { id: 'tenner_24_09', descriptor: 'manual focus', option_index: 9 }
                ],
                'T25': [
                    { id: 'tenner_25_00', descriptor: 'smooth motion', option_index: 0 },
                    { id: 'tenner_25_01', descriptor: 'static pose', option_index: 1 },
                    { id: 'tenner_25_02', descriptor: 'dynamic motion', option_index: 2 },
                    { id: 'tenner_25_03', descriptor: 'flowing motion', option_index: 3 },
                    { id: 'tenner_25_04', descriptor: 'jerky motion', option_index: 4 },
                    { id: 'tenner_25_05', descriptor: 'rhythmic motion', option_index: 5 },
                    { id: 'tenner_25_06', descriptor: 'erratic motion', option_index: 6 },
                    { id: 'tenner_25_07', descriptor: 'graceful motion', option_index: 7 },
                    { id: 'tenner_25_08', descriptor: 'mechanical motion', option_index: 8 },
                    { id: 'tenner_25_09', descriptor: 'organic motion', option_index: 9 }
                ],
                'T26': [
                    { id: 'tenner_26_00', descriptor: 'symmetrical composition', option_index: 0 },
                    { id: 'tenner_26_01', descriptor: 'asymmetrical composition', option_index: 1 },
                    { id: 'tenner_26_02', descriptor: 'rule of thirds', option_index: 2 },
                    { id: 'tenner_26_03', descriptor: 'golden ratio', option_index: 3 },
                    { id: 'tenner_26_04', descriptor: 'centered composition', option_index: 4 },
                    { id: 'tenner_26_05', descriptor: 'off-center composition', option_index: 5 },
                    { id: 'tenner_26_06', descriptor: 'diagonal composition', option_index: 6 },
                    { id: 'tenner_26_07', descriptor: 'triangular composition', option_index: 7 },
                    { id: 'tenner_26_08', descriptor: 'circular composition', option_index: 8 },
                    { id: 'tenner_26_09', descriptor: 'linear composition', option_index: 9 }
                ],
                'T27': [
                    { id: 'tenner_27_00', descriptor: 'warm atmosphere', option_index: 0 },
                    { id: 'tenner_27_01', descriptor: 'cool atmosphere', option_index: 1 },
                    { id: 'tenner_27_02', descriptor: 'mysterious atmosphere', option_index: 2 },
                    { id: 'tenner_27_03', descriptor: 'cheerful atmosphere', option_index: 3 },
                    { id: 'tenner_27_04', descriptor: 'melancholy atmosphere', option_index: 4 },
                    { id: 'tenner_27_05', descriptor: 'dramatic atmosphere', option_index: 5 },
                    { id: 'tenner_27_06', descriptor: 'peaceful atmosphere', option_index: 6 },
                    { id: 'tenner_27_07', descriptor: 'tense atmosphere', option_index: 7 },
                    { id: 'tenner_27_08', descriptor: 'romantic atmosphere', option_index: 8 },
                    { id: 'tenner_27_09', descriptor: 'nostalgic atmosphere', option_index: 9 }
                ],
                'T28': [
                    { id: 'tenner_28_00', descriptor: 'natural shadows', option_index: 0 },
                    { id: 'tenner_28_01', descriptor: 'dramatic shadows', option_index: 1 },
                    { id: 'tenner_28_02', descriptor: 'soft shadows', option_index: 2 },
                    { id: 'tenner_28_03', descriptor: 'hard shadows', option_index: 3 },
                    { id: 'tenner_28_04', descriptor: 'long shadows', option_index: 4 },
                    { id: 'tenner_28_05', descriptor: 'short shadows', option_index: 5 },
                    { id: 'tenner_28_06', descriptor: 'multiple shadows', option_index: 6 },
                    { id: 'tenner_28_07', descriptor: 'colored shadows', option_index: 7 },
                    { id: 'tenner_28_08', descriptor: 'cast shadows', option_index: 8 },
                    { id: 'tenner_28_09', descriptor: 'ambient shadows', option_index: 9 }
                ],
                'T29': [
                    { id: 'tenner_29_00', descriptor: 'bright highlights', option_index: 0 },
                    { id: 'tenner_29_01', descriptor: 'subtle highlights', option_index: 1 },
                    { id: 'tenner_29_02', descriptor: 'specular highlights', option_index: 2 },
                    { id: 'tenner_29_03', descriptor: 'diffuse highlights', option_index: 3 },
                    { id: 'tenner_29_04', descriptor: 'rim lighting', option_index: 4 },
                    { id: 'tenner_29_05', descriptor: 'back lighting', option_index: 5 },
                    { id: 'tenner_29_06', descriptor: 'side lighting', option_index: 6 },
                    { id: 'tenner_29_07', descriptor: 'front lighting', option_index: 7 },
                    { id: 'tenner_29_08', descriptor: 'top lighting', option_index: 8 },
                    { id: 'tenner_29_09', descriptor: 'bottom lighting', option_index: 9 }
                ],
                'T30': [
                    { id: 'tenner_30_00', descriptor: 'textured surface', option_index: 0 },
                    { id: 'tenner_30_01', descriptor: 'smooth surface', option_index: 1 },
                    { id: 'tenner_30_02', descriptor: 'rough surface', option_index: 2 },
                    { id: 'tenner_30_03', descriptor: 'glossy surface', option_index: 3 },
                    { id: 'tenner_30_04', descriptor: 'matte surface', option_index: 4 },
                    { id: 'tenner_30_05', descriptor: 'metallic surface', option_index: 5 },
                    { id: 'tenner_30_06', descriptor: 'fabric surface', option_index: 6 },
                    { id: 'tenner_30_07', descriptor: 'wood surface', option_index: 7 },
                    { id: 'tenner_30_08', descriptor: 'stone surface', option_index: 8 },
                    { id: 'tenner_30_09', descriptor: 'glass surface', option_index: 9 }
                ],
                'T31': [
                    { id: 'tenner_31_00', descriptor: 'detailed rendering', option_index: 0 },
                    { id: 'tenner_31_01', descriptor: 'simplified rendering', option_index: 1 },
                    { id: 'tenner_31_02', descriptor: 'stylized rendering', option_index: 2 },
                    { id: 'tenner_31_03', descriptor: 'photorealistic rendering', option_index: 3 },
                    { id: 'tenner_31_04', descriptor: 'artistic rendering', option_index: 4 },
                    { id: 'tenner_31_05', descriptor: 'minimalist rendering', option_index: 5 },
                    { id: 'tenner_31_06', descriptor: 'complex rendering', option_index: 6 },
                    { id: 'tenner_31_07', descriptor: 'abstract rendering', option_index: 7 },
                    { id: 'tenner_31_08', descriptor: 'geometric rendering', option_index: 8 },
                    { id: 'tenner_31_09', descriptor: 'organic rendering', option_index: 9 }
                ],
                'T32': [
                    { id: 'tenner_32_00', descriptor: 'positive message', option_index: 0 },
                    { id: 'tenner_32_01', descriptor: 'encouraging message', option_index: 1 },
                    { id: 'tenner_32_02', descriptor: 'inspirational message', option_index: 2 },
                    { id: 'tenner_32_03', descriptor: 'humorous message', option_index: 3 },
                    { id: 'tenner_32_04', descriptor: 'thoughtful message', option_index: 4 },
                    { id: 'tenner_32_05', descriptor: 'mysterious message', option_index: 5 },
                    { id: 'tenner_32_06', descriptor: 'playful message', option_index: 6 },
                    { id: 'tenner_32_07', descriptor: 'wise message', option_index: 7 },
                    { id: 'tenner_32_08', descriptor: 'hopeful message', option_index: 8 },
                    { id: 'tenner_32_09', descriptor: 'peaceful message', option_index: 9 }
                ]
            },
